---
title: "🗓️ Week 5 - Practical exercise"
---
...
To use the framework in GEE code editor, go to [this repository](https://code.earthengine.google.com/?accept_repo=users/adugnagirma/gee_s1_ard) and copy the contents of the *s1_ard.js* script  to your own repository. The path to the preprocessing functions is a public so you don't need to copy them.
